...
def get_chord(notes, freqs, guitar):
    ...
    tabs = get_tabs_layout(new_chord, notes, freqs, guitar, is_chord)
    return [chord_name, tabs]


def get_tabs_layout(chord, notes, freqs, guitar,is_chord):
    # understand best layout for chords/tabs
